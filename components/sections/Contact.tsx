...
export const Contact = () => {
    ...
    const handleMeetingSubmit = (e: React.FormEvent) => {
        ...
        console.log("Toplantı rezervasyonu:", meetingForm);
    ...
    const handleVisitSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // TODO: Backend'e gönder
        console.log("Ziyaret randevusu:", visitForm);
                        ...
                        {activeTab === 'message' && (
                            <>
                                ...
                                <form className="space-y-6">
                                    ...
                                    <button type="button" className="w-full py-4 bg-primary hover:bg-primary/80 text-white font-orbitron font-bold tracking-widest rounded-lg flex items-center justify-center gap-2 group transition-all">
                                ...
                                {meetingSubmitted ? (
                                    ...
                                    <>
                                        ...
                                        <form onSubmit={handleMeetingSubmit} className="space-y-4">
                                            ...
                                            <button type="submit" className="w-full py-4 bg-gradient-to-r from-primary to-purple-600 text-white font-orbitron font-bold tracking-widest rounded-lg flex items-center justify-center gap-2 transition-all hover:opacity-90">
