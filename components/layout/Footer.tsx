...
export const Footer = () => {
    return (
        <>
            <PartnerLogos />
            <footer className="relative bg-black text-gray-400 border-t border-primary/20 pt-16 pb-8 overflow-hidden">
                {/* Decorative Elements */}
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                        ...
                        <div className="space-y-4">
                            <h2 className="font-orbitron text-2xl text-white font-bold tracking-wider">
                        ...
                        {/* Quick Links */}
                        <div className="space-y-4">
                            <h3 className="text-white font-bold uppercase tracking-wider text-sm border-l-2 border-secondary pl-3">
                                Hızlı Erişim
                            </h3>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4">
                                <a href="https://www.instagram.com/ikuantstekmer/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 hover:text-white transition-all transform hover:scale-110">
                                    <Instagram className="w-5 h-5" />
                                </a>
                                <a href="https://www.linkedin.com/company/ikuants-tekmer/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded hover:bg-blue-600 hover:text-white transition-all transform hover:scale-110">
                                    <Linkedin className="w-5 h-5" />
                                </a>
                                <a href="https://chat.whatsapp.com/LAg3l2cUSFOHBn0miCO9lz" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded hover:bg-green-500 hover:text-white transition-all transform hover:scale-110">
