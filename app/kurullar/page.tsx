        ...
        <div className="py-24 relative min-h-screen">
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {board.members.map((member, index) => (
                                        <motion.div
                                            ...
                                            className="group"
                                        >
                                            <div className="p-6 rounded-2xl bg-gradient-to-br from-white/10 to-white/[0.02] border border-white/10 hover:border-primary/40 transition-all hover:shadow-lg hover:shadow-primary/10">
                ...
                <motion.div
                    ...
                    className="mt-16 p-8 rounded-2xl bg-gradient-to-r from-primary/10 via-purple-600/5 to-secondary/10 border border-white/10"
                >
                    <h3 className="font-orbitron text-xl text-white mb-4">Kurullarımız Hakkında</h3>
