        ...
        <div className="py-24 relative min-h-screen">
            ...
            <div className="container mx-auto px-6 max-w-5xl relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    {teamMembers.map((member, index) => (
                        <motion.div
                            ...
                            className="group relative p-8 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 hover:border-primary/40 transition-all"
                        >
                            {/* Avatar */}
                            ...
                            <div className="flex flex-wrap gap-2">
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-gray-300 hover:text-white hover:border-primary/50 transition-all text-sm"
                                >
                ...
                >
                    ...
                    <h3 className="font-orbitron text-xl text-white mb-3">Ekibimizle İletişim Kurun</h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a
                            href="/iletisim"
                            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/10 border border-white/20 text-white rounded-lg hover:bg-white/20 transition-all font-semibold"
                        >
